...
//此类不用修改，和Jbutton一样使用
//浅蓝色按钮
public class RButton1 extends JButton {
    //判断类的serialVersionUID来验证版本一致性的
    private static final long serialVersionUID = 39082560987930759L;


    //默认颜色 两种渐变色
    private Color BUTTON_COLOR1 = new Color(138,184,230);
    private Color BUTTON_COLOR2 = new Color(138,184,230);
    ...
    //按下按钮时字体的默认颜色
    private Color BUTTON_FOREGROUND_COLOR1 =  Color.WHITE;
    private Color BUTTON_FOREGROUND_COLOR2 = Color.WHITE;
    //默认字体
    private Font font = new Font("Times New Roman",Font.BOLD,17);
    //判断是否按下
    ...
    public RButton1(ImageIcon icon) {
        setIcon(icon);
        Init();
    }
    public RButton1(String name) {
        setText(name);
        Init();
    }
    public RButton1() {
