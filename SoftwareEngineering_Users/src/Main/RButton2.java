...
public class RButton2 extends JButton {
    //判断类的serialVersionUID来验证版本一致性的
    private static final long serialVersionUID = 39082560987930759L;


    //默认颜色 两种渐变色
    private Color BUTTON_COLOR1 = new Color(128,128,128);
    private Color BUTTON_COLOR2 = new Color(128,128,128);
    ...
    public RButton2(ImageIcon icon) {
        setIcon(icon);
        Init();
    }
    public RButton2(String name) {
        setText(name);
        Init();
    }
    public RButton2() {
